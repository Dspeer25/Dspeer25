...
export function computeAttributes(trades: Trade[]): AttributeScore[] {
  ...
  return [
    ...
    { name: 'FOMO Resistance', value: clamp(90 - fomoCount * 18), color: '#FF6B35' },
    { name: 'Revenge Control', value: clamp(90 - revengeCount * 22), color: '#FF6B35' },
    // Core attributes
    ...
    { name: 'Emotional Control', value: clamp(70 - revengeCount * 15 - fomoCount * 10), color: '#FF6B35' },
...
const defaultAttributes: AttributeScore[] = [
  ...
  { name: 'FOMO Resistance', value: 54, color: '#FF6B35' },
  { name: 'Revenge Control', value: 46, color: '#FF6B35' },
  ...
  { name: 'Emotional Control', value: 42, color: '#FF6B35' },
