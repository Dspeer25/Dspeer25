  ...
  return (
    <>
      ...
      <nav style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "24px 40px 0", borderBottom: "1px solid #1a1b22", overflow: "visible", position: 'relative' }}>
        <div onClick={view === 'app' ? onLogoClick : undefined} style={{ marginBottom: 20, cursor: view === 'app' ? 'pointer' : 'default' }}>
        ...
        <div style={{ display: "flex", gap: 5, width: "100%", maxWidth: 920 }}>
          {tabs.map(t => (
            <span
              ...
              style={{
                fontSize: 14, color: teal, letterSpacing: "0.04em", padding: "14px 16px 16px", cursor: "pointer", fontFamily: fm, borderRadius: "8px 8px 0 0", fontWeight: 600,
                background: view === 'app' && activeTab === t ? "rgba(0,212,160,0.18)" : "rgba(0,212,160,0.05)",
                borderTop: view === 'app' && activeTab === t ? `1px solid ${teal}` : "1px solid rgba(0,212,160,0.18)",
                borderRight: view === 'app' && activeTab === t ? `1px solid ${teal}` : "1px solid rgba(0,212,160,0.18)",
                borderBottom: "none",
                borderLeft: view === 'app' && activeTab === t ? `1px solid ${teal}` : "1px solid rgba(0,212,160,0.18)",
